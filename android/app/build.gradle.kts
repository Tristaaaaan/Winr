...
val flutterVersionCode: Int = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 12
val flutterVersionName: String = localProperties.getProperty("flutter.versionName") ?: "1.0.12"
