...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<WinRateRecords>? record});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({final List<WinRateRecords>? record}) : _record = record;
...
abstract class _Loaded implements HistoryState {
  const factory _Loaded({final List<WinRateRecords>? record}) = _$LoadedImpl;
